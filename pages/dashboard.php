                        ...
                        <div class="card mx-3 mb-2">
                            ...
                            ?> </div>
                                ...
                                <?php
                                    ...
                                    <div class="col-lg-2 col-md-6 col-sm-6"> <a href="pricing.php" class="btn btn-outline-success btn-sm">
                                    <?php echo $status ==  'Online' ? 'Mining Started': 'Get Server';?></a>
                                    <?php 
                                    if($status == 'Online'){
//                                        echo '<a href="#" class="p-2 text-success " data-bs-toggle="modal" data-bs-target="#exampleModal"><h5 class="btn btn-info btn-sm">Mining Activated</h5></a>';
                                        echo '<img src="https://media.tenor.com/guhB4PpjrmUAAAAC/loading-loading-gif.gif" class="img-fluid" width="50px"/>';
                                    }else{
