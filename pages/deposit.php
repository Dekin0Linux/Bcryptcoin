    ...
    <div class="container w-lg-50 my-5">
        ...
        <div class="card">
            ...
            <form id="depositForm" class="m-auto w-75 my-2">
                ...
                <div>
                    <input type="submit" class="form-control lead btn btn-success" value="Confirm" name="deposit">
                </div>
        ...
        <div class="p-2 bg-info rounded">
            <h6 class=" text-light text-center">
                Scan the QRcode or copy and paste the address in your blockchain app and click CONFIRM only when your payment is sent. <br>
